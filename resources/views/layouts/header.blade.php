                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            @if (Auth::user()->getPessoa->avatar == null)
                                <img class="rounded-circle header-profile-user"
                                    src="{{ asset('assets/template/images/users/user_default.jpg') }}"
                                    alt="Header Avatar">
                            @else
                            ...
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{ Auth::user()->getPessoa->nome }}</span>
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ Auth::user()->getPermissao->descricao }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Bem-vindo {{ Auth::user()->getPessoa->nome }}!</h6>
                        ...
                        <a class="dropdown-item" href="{{ route('actividades') }}"><i
                                class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Actividades Sistema</span></a>
