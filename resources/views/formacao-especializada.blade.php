...
<head>
    ...
    <meta charset="utf-8" />
    <title>CEF | Formação Especializada</title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-sm-12">
                        <div class="mt-lg-5 pt-5 mb-5">
                            <p class="formation-date">16 janeiro 2025 a 10 abril 2025</p>
                            <h1 class="title-formation fw-bold">Formação Especializada em Regulação e Supervisão do
                                Mercado Bancário</h1>
                            <p class="lead description-formation lh-base">A formação terá como meta aprofundar os temas
                                actuais inerentes ao mercado Bancário,
                                ...
                                legislativa e operacional que tem vindo a ser feita nos últimos anos em Angola.</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-lg-10 col-sm-12 col-12">
                        <section id="apresentacao" class="presentation-section mb-4">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="genques-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body ff-secondary">
                                            ...
                                            <p class="subject">Público-alvo:</p>
                                            <p class="description">O curso é dirigido a juristas, recém-licenciados em
                                                Direito, advogados, magistrados, quadros dirigentes e técnicos/as
                                                superiores das várias áreas governativas do Estado e da sociedade civil
                                                e outros licenciados e profissionais das áreas da Família e das
                                                Crianças. </p>
                                            <div class="row">
                                                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                                    <p class="subject">Data:</p>
                                                    <p class="description">16 janeiro 2025 a 10 abril 2025 </p>
                                                </div>
                                                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                                    <p class="subject">Horário:</p>
                                                    <p class="description">18h-20h </p>
                                                </div>
                                                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                                                    <p class="subject">Investimento:</p>
                                                    <p class="description">150.000,00 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body text-center p-4">
                                                            <div class="avatar-xl mx-auto mb-4 position-relative">
                                                                <img src="{{ asset('assets/template/images/users/avatar-3.jpg') }}"
                                                                    alt="" class="img-fluid rounded-circle">
                                                            </div>
                                                            <!-- end card body -->
                                                            <a href="{{ url('/perfil-formador') }}" class="mb-1 text-black link-formador">Dra. Joana Farrajota
                                                            </a>
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="card">
                                                        <div class="card-body text-center p-4">
                                                            ...
                                                            <!-- end card body -->
                                                            <a href="{{ url('/perfil-formador') }}" class="mb-1 text-black link-formador">Dr. Carlos Molar
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <!-- end card -->
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="card">
                                                        <div class="card-body text-center p-4">
                                                            ...
                                                            <!-- end card body -->
                                                            <a href="{{ url('/perfil-formador') }}" class="mb-1 text-black link-formador">Dr. Olavo Silva</a>
                                                        </div>
                                                    </div>
                                                    <!-- end card -->
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="card">
                                                        <div class="card-body text-center p-4">
                                                            ...
                                                            <a href="{{ url('/perfil-formador') }}" class="mb-1 text-black link-formador">Dr. Miguel de Carvalho
                                                            </a>
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div class="card">
                                                        <div class="card-body text-center p-4">
                                                            ...
                                                            <a href="{{ url('/perfil-formador') }}" class="mb-1 text-black link-formador">Dra. Nilda Silva
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <section id="conteudo" class="content-section mb-3">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 mb-4">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-sm">
                                                <div class="avatar-title bg-transparent text-black rounded-circle">
                                                    <i class="ri-stack-line fs-36"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 title-modulo">
                                            <p class="duration">Duração: (1.º dia/
                                                3 h)</p>
                                            <h5 class="">Módulo I – Direito Bancário e sua contextualização global nos
                                                dias de hoje </h5>
                                            <h5 class="professor">Formador(a): Dra. Joana Farrajota (Vice Dean da NOVA
                                                School of Law-UNL)</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 title-modulo">
                                            <p class="duration">Duração: (2.º
                                                dia /3h)</p>
                                            <h5 class="">Módulo II – Regulação do Mercado Bancário e as novas
                                                competências do BNA </h5>
                                            <h5 class="professor">Formador(a): Dr. Carlos Molar (BNA)</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 title-modulo">
                                            <p class="duration">Duração: (3.º dia/3h)</p>
                                            <h5 class="">Módulo III – Da independência ou Autonomia do BNA </h5>
                                            <h5 class="professor">Formador(a): Dr. Olavo Silva (ARC e Jurista)</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 title-modulo">
                                            <p class="duration">Duração: (4.º dia/3h)</p>
                                            <h5 class="">Módulo IV – Novos modelos de supervisão do Mercado Bancário em
                                                Angola </h5>
                                            <h5 class="professor">Formador(a): Dr. Miguel de Carvalho (ANPG e Professor
                                                de Dto. Bancário) e a Dra. Nilda
                                                Silva (BNA e Advogada)</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="col-lg-6 mb-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 title-modulo">
                                            <p class="duration">Duração: 2 semanas</p>

                                            <h5 class="">Módulo 5: Audição da Criança em Contexto de Responsabilidades
                                                Parentais</h5>
                                        </div>
                                    </div>
                                </div> -->
                        ...
                        <section id="inscricao" class="inscricao-section mb-5">
                                                ...
                                                <div class="live-preview">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-xxl-6 col-lg-6 col-md-3">
                                                            ...
                                                            <label for="telefone1" class="form-label">Profissão</label>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-xxl-6 col-lg-6 col-md-6">
                                                            ...
                                                            <label for="telefone1" class="form-label">Província</label>
                                                            <select name="" id="" class="form-control">
                                                                <option value=""></option>
                                                            </select>
                                                        ...
                                                        <div class="col-xxl-6 col-lg-6 col-md-6">
                                                            ...
                                                            <label for="telefone2" class="form-label">Nº Bilhete</label>
                                                            <input type="text" class="form-control" id="telefone2"
                                                                maxlength="14" name="telefone2" placeholder="">
                                                    ...
                                                    <div class="row gy-4 mt-2">
                                                        ...
                                                        <div class="col-xxl-6 col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                                            <div>
                                                                <label for="num_cedula" class="form-label">N.º Telefone
                                                                </label>
                                                                <input type="text" class="form-control" id="num_cedula"
                                                                    name="num_cedula" maxlength="6">
                                                            </div>
                                                        </div>

                                                        <div class="col-xxl-6 col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                                            <div>
                                                                <label for="basiInput" class="form-label">Género
                                                                </label>
                                                                <br>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-check form-check-inline">
                                                                ...
                                                                <label style="font-weight: bold"
                                                                    class="form-check-label" for="autorizacao">Tomei
                                                                    conhecimento da política de privacidade da
                                                                    Jurisnova.</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="dv-botao-submeter" class="mt-4">
                                                        <a id="btn-submeter" class="btn btn-primary text-black"
