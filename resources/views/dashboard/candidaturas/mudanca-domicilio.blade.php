    ...
    <div class="row">
        ...
        <div class="col-xl-9">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title flex-grow-1 mb-0">Mudança de domicílio</h5>
                        <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    ...
                    @if ($tem == true)
                        ...
                        <div class="text-left alert alert-info">
                            ...
                            <h4>
                                ...
                                Domicílio actual: {{ $domicilio_actual }}
                            </h4>
                        </div>
                    @endif
                    ...
                    <form action="">
                        ...
                        <label for="">Escolha o novo domicílio</label>
                        <select class="form-control" name="" id="" wire:model="provincia_id">
