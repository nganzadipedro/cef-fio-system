                                    ...
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <a id="botao_terminar" wire:click="verifica_tempo" hidden>Terminar Prova</a>
                            ...
                            @if($pergunta->opcao4 != null)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="opcao" wire:model="opcao" id="opcao4"
                                        value="opcao4">
                                    <label class="form-check-label" for="opcao4">{{ $pergunta->opcao1 }}</label>
                                </div>
                                <br>
                            @endif
                            @if($pergunta->opcao5 != null)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="opcao" wire:model="opcao" id="opcao5"
                                        value="opcao5">
                                    <label class="form-check-label" for="opcao5">{{ $pergunta->opcao1 }}</label>
                                </div>
                                <br>
                            @endif
                            <br>
