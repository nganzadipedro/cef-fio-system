            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        <h6 class="card-title mb-0">CONFIGURAR SISTEMA DE AVALIAÇÃO</h6>
                    </div>
                ...
                <form method="POST" wire:submit.prevent="cadastrar">
                    <div class="row">
                        ...
                        @if ($qtd_notas_lancar == 2)
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="firstNameinput" class="form-label">Fórmula de Obtenção da nota final</label>
                        ...
                        @if($criterio_resultado_final == 'criterio-percentual')
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <input wire:model="percent_nota1" min="1" max="100" type="number" class="form-control"
                                        id="percent_nota1">
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <input wire:model="percent_nota2" min="1" max="100" type="number" class="form-control"
                                        id="percent_nota2">
                                </div>
                            </div>
                        @endif
...
<div class="row">
    ...
    <div class="col-xl-12" id="card-none2">
        ...
        <div class="card mt-2">
            <div class="card-header">
                <h6 class="card-title mb-0 flex-grow-1">Listagem geral das avaliações configuradas</h6>
            </div>
            <div class="card-body">
                        ...
                        <tbody style="height:200px;overflow:auto;">
                            @foreach ($lista as $item)
                                <tr>
                                    ...
                                    <td scope="col">{{ $item->getturma->descricao }} - {{ $item->getturma->getformacao->nome }}</td>
                                    <td scope="col">{{ $item->tipo_prova }}</td>
                                    <td scope="col">{{ $item->qtd_notas_lancar }}</td>
                                    <td scope="col">{{ $item->criterio_resultado_final == null ? '------' : $item->criterio_resultado_final }}</td>
                                    <td scope="col">{{ $item->percent_nota1 == null ? '------' : $item->percent_nota1 . '%' }}</td>
                                    <td scope="col">{{ $item->percent_nota2 == null ? '------' : $item->percent_nota2 . '%' }}</td>
                                    <td class="">
                                       
                                        <a class="btn btn-danger" href="{{ route('provas.editar', ['hash' => $item->hash]) }}"
                                            title="Editar Prova">Eliminar</a>
