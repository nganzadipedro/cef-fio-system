                    ...
                    <div class="row">
                        <div class="col-xxl-12 align-self-center text-center">
                            <div class="py-4">
                                ...
                                <h5 class="display-6">Painel de Gerenciamento Provincial</h5>
                                <h4>Província: {{ Auth::user()->getprovincia->descricao }}</h4>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                        <div class="col">
                            <div class="py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-13">Total de Candidaturas
                                </h5>
                        ...
                        <div class="col">
                            <a href="{{ route('candidaturas.aprovadas') }}">
                                <div class="mt-3 mt-md-0 py-4 px-3">
                                    <h5 class="text-muted text-uppercase fs-13">Candidaturas aprovadas
                                    </h5>
                                    <div class="d-flex align-items-center">
                                        <!-- <div class="flex-shrink-0">
                                        <i class="ri-exchange-dollar-line display-6 text-muted"></i>
                        ...
                        <div class="col">
                            <a href="{{ route('candidaturas.suspensas') }}">
                                <div class="mt-3 mt-md-0 py-4 px-3">
                                    <h5 class="text-muted text-uppercase fs-13">Candidaturas Suspensas
                                    </h5>
                                    <div class="d-flex align-items-center">
                                        <!-- <div class="flex-shrink-0">
                                            <i class="ri-pulse-line display-6 text-muted"></i>
                        ...
                        <div class="card-body">
                            ...
                            @if (count($turmas) == 0)
                                ...
                                <div class="alert alert-primary text-center">
                                    <h5 class="">Ainda não existem turmas disponíveis.</h5>
                                </div>
